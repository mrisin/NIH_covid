...
```{r climate and geographic state data}
...
climdata1 <- read.csv("ClimateData/Ginny_TMN.csv") %>% 
  filter(year == 2010) %>% 
  select(c(5:55)) %>% 
  pivot_longer(cols=c(1:51),names_to = "STID", values_to = "Min_Temp") %>% 
  group_by(STID) %>% 
  slice(which.min(Min_Temp)) %>%
  ungroup() %>%
  mutate(STID = str_remove_all(STID, "state"))

climdata1$STID %<>% as.numeric()

climdata2 <- read.csv("ClimateData/Ginny_TMX.csv") %>% 
  filter(year == 2010) %>% 
  select(c(5:55)) %>% 
  pivot_longer(cols=c(1:51),names_to = "STID", values_to = "Max_Temp") %>% 
  group_by(STID) %>% 
  slice(which.max(Max_Temp)) %>%
  ungroup() %>%
  mutate(STID = str_remove_all(STID, "state"))

climdata2$STID %<>% as.numeric()

climdata3 <- read.csv("ClimateData/Ginny_TMP.csv") %>% 
  filter(year == 2010) %>% 
  select(c(3,5:55)) %>% 
  pivot_longer(cols=c(2:52),names_to = "STID", values_to = "Av_Temp") %>% 
  group_by(STID) %>% 
  summarise(across(-month, mean)) %>%
  ungroup() %>%
  mutate(STID = str_remove_all(STID, "state"))

climdata3$STID %<>% as.numeric()

climdata4 <- read.csv("ClimateData/Ginny_PRE.csv") %>% filter(year == 2010) %>% 
  select(c(3,5:55)) %>% 
  pivot_longer(cols=c(2:52),names_to = "STID", values_to = "Total_PRE") %>% 
  group_by(STID) %>% 
  summarise(across(-month, sum)) %>%
  ungroup() %>%
  mutate(STID = str_remove_all(STID, "state"))
  
climdata4$STID %<>% as.numeric()

climdata <- left_join(climdata1,climdata2, by = "STID") %>% 
  mutate("Temp_Dif" = (Max_Temp - Min_Temp)) %>%
  left_join(., climdata3, by = "STID") %>%
  left_join(., climdata4, by = "STID")

StateID <- read.csv("ClimateData/Ginny_StatesID.csv") %>%
  select(c(1,3)) %>%
  rename(region = STNAME) %>%
  filter(STID != 52) %>%
  left_join(., climdata, by = "STID") %>%
  select(c(-1))

StateDesc %<>% left_join(., StateID, by = "region") %>%
...
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
mtext(paste0("p=", test), side = 3, line = 0.5, col = "red", cex = 0.9)
...
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
mtext(paste0("p=", test), side = 3, line = 0.5, col = "red", cex = 0.9)

## panel 3: peak timing as a function of latitude
plot(all$phase.ann,all$Latitude, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Latitude',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
...
plot(all$phase.ann,all$Longitude, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Longitude',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
...
plot(all$rel.amp.ann,log(all$population),cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
...
plot(all$ratio,log(all$population), cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
...
plot(all$phase.ann,log(all$population), cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
...
### ROLLING AVERAGES
jpeg("graphs/Sept20_ra.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
par(mfrow=c(3,3), mar= c(5, 5, 5, 5))
## panel 1: amplitude of annual cycle as a function of latitude
plot(all.ra$rel.amp.ann,all.ra$Latitude,cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='Latitude',cex.lab=1.4,cex.axis=1.2)
title('Annual amplitude',cex.main=1.5)
reg=lm(all.ra$rel.amp.ann~all.ra$Latitude)
reg2=lm(all.ra$rel.amp.ann~all.ra$Latitude,weight=all.ra$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 2: : importance of 6-mo cycle as a function of latitude
plot(all.ra$ratio,all.ra$Latitude, cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Latitude',cex.lab=1.4,cex.axis=1.2)
reg=lm(all.ra$ratio~all.ra$Latitude)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all.ra$ratio~all.ra$Latitude,weight=all.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 3: peak timing as a function of latitude
plot(all.ra$phase.ann,all.ra$Latitude, cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Latitude',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
reg=lm(all.ra$phase.ann~all.ra$Latitude)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all.ra$phase.ann~all.ra$Latitude,weight=all.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Peak timing',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 4: amplitude of annual cycle as a function of longitude
plot(all.ra$rel.amp.ann,all.ra$Longitude,cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='Longitude',cex.lab=1.4,cex.axis=1.2)
reg=lm(all.ra$rel.amp.ann~all.ra$Longitude)
reg2=lm(all.ra$rel.amp.ann~all.ra$Longitude,weight=all.ra$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Annual amplitude',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 5: : importance of 6-mo cycle as a function of longitude
plot(all.ra$ratio,all.ra$Longitude, cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Longitude',cex.lab=1.4,cex.axis=1.2)
reg=lm(all.ra$ratio~all.ra$Longitude)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all.ra$ratio~all.ra$Longitude,weight=all.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=
1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 6: peak timing as a function of longitude
plot(all.ra$phase.ann,all.ra$Longitude, cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Longitude',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
reg=lm(all.ra$phase.ann~all.ra$Longitude)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all.ra$phase.ann~all.ra$Longitude,weight=all.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Peak timing',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 7: amplitude of annual cycle as a function of population
plot(all.ra$rel.amp.ann,log(all.ra$population),cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
reg=lm(all.ra$rel.amp.ann~all.ra$population)
reg2=lm(all.ra$rel.amp.ann~all.ra$population,weight=all.ra$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Annual amplitude',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 8: : importance of 6-mo cycle as a function of population
plot(all.ra$ratio,log(all.ra$population), cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
reg=lm(all.ra$ratio~all.ra$population)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all.ra$ratio~all.ra$population,weight=all.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=
1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 9: peak timing as a function of population
plot(all.ra$phase.ann,log(all.ra$population), cex=(all.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
reg=lm(all.ra$phase.ann~all.ra$population)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all.ra$phase.ann~all.ra$population,weight=all.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Peak timing',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 3: peak timing as a function of latitude
plot(all2$phase.ann,all$Latitude, cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Latitude',cex.lab=1.4,cex.axis=1.2)
...
## panel 6: peak timing as a function of longitude
plot(all2$phase.ann,all2$Longitude, cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Longitude',cex.lab=1.4,cex.axis=1.2)
...
## panel 7: amplitude of annual cycle as a function of population
plot(all2$rel.amp.ann,log(all2$population),cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
...
## panel 8: : importance of 6-mo cycle as a function of population
plot(all2$ratio,log(all2$population), cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
...
## panel 9: peak timing as a function of population
plot(all2$phase.ann,log(all2$population), cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2, xlim = c(0,15))
...
### ROLLING AVERAGES
jpeg("graphs/April22_ra.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
par(mfrow=c(3,3), mar= c(5, 5, 5, 5))
## panel 1: amplitude of annual cycle as a function of latitude
plot(all2.ra$rel.amp.ann,all2.ra$Latitude,cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='Latitude',cex.lab=1.4,cex.axis=1.2)
title('Annual amplitude',cex.main=1.5)
reg=lm(all2.ra$rel.amp.ann~all2.ra$Latitude)
reg2=lm(all2.ra$rel.amp.ann~all2.ra$Latitude,weight=all2.ra$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 2: : importance of 6-mo cycle as a function of latitude
plot(all2.ra$ratio,all2.ra$Latitude, cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Latitude',cex.lab=1.4,cex.axis=1.2)
reg=lm(all2.ra$ratio~all2.ra$Latitude)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all2.ra$ratio~all2.ra$Latitude,weight=all2.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 3: peak timing as a function of latitude
plot(all2.ra$phase.ann,all2.ra$Latitude, cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Latitude',cex.lab=1.4,cex.axis=1.2)
reg=lm(all2.ra$phase.ann~all2.ra$Latitude)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all2.ra$phase.ann~all2.ra$Latitude,weight=all2.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Peak timing',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 4: amplitude of annual cycle as a function of longitude
plot(all2.ra$rel.amp.ann,all2.ra$Longitude,cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='Longitude',cex.lab=1.4,cex.axis=1.2)
reg=lm(all2.ra$rel.amp.ann~all2.ra$Longitude)
reg2=lm(all2.ra$rel.amp.ann~all2.ra$Longitude,weight=all2.ra$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Annual amplitude',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 5: : importance of 6-mo cycle as a function of longitude
plot(all2.ra$ratio,all2.ra$Longitude, cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Longitude',cex.lab=1.4,cex.axis=1.2)
reg=lm(all2.ra$ratio~all2.ra$Longitude)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all2.ra$ratio~all2.ra$Longitude,weight=all2.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=
1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 6: peak timing as a function of longitude
plot(all2.ra$phase.ann,all2.ra$Longitude, cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Longitude',cex.lab=1.4,cex.axis=1.2)
reg=lm(all2.ra$phase.ann~all2.ra$Longitude)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all2.ra$phase.ann~all2.ra$Longitude,weight=all2.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Peak timing',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 7: amplitude of annual cycle as a function of population
plot(all2.ra$rel.amp.ann,log(all2.ra$population),cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
reg=lm(all2.ra$rel.amp.ann~all2.ra$population)
reg2=lm(all2.ra$rel.amp.ann~all2.ra$population,weight=all2.ra$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Annual amplitude',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 8: : importance of 6-mo cycle as a function of population
plot(all2.ra$ratio,log(all2.ra$population), cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
reg=lm(all2.ra$ratio~all2.ra$population)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all2.ra$ratio~all2.ra$population,weight=all2.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=
1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 9: peak timing as a function of population
plot(all2.ra$phase.ann,log(all2.ra$population), cex=(all2.ra$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='log( Population Size )',cex.lab=1.4,cex.axis=1.2)
reg=lm(all2.ra$phase.ann~all2.ra$population)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all2.ra$phase.ann~all2.ra$population,weight=all2.ra$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Peak timing',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
```{r seasonality plots with climate}
jpeg("graphs/Sep20_clim.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
par(mfrow=c(2,3), mar= c(5, 5, 5, 5))
## panel 1: amplitude of annual cycle as a function of temperature
plot(all$rel.amp.ann,all$Temp_Dif,cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='Temperature (Max-Min)',cex.lab=1.4,cex.axis=1.2)
reg=lm(all$rel.amp.ann~all$Temp_Dif)
reg2=lm(all$rel.amp.ann~all$Temp_Dif,weight=all$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Annual amplitude',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 2: : importance of 6-mo cycle as a function of temperature
plot(all$ratio,all$Temp_Dif, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Temperature (Max-Min)',cex.lab=1.4,cex.axis=1.2)
reg=lm(all$ratio~all$Temp_Dif)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all$ratio~all$Temp_Dif,weight=all$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=
1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 3: peak timing as a function of temperature
plot(all$phase.ann,all$Temp_Dif, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Temperature (Max-Min)',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,0))
reg=lm(all$phase.ann~all$Temp_Dif)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all$phase.ann~all$Temp_Dif,weight=all$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Peak timing',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 4: amplitude of annual cycle as a function of av temperature
plot(all$rel.amp.ann,all$Temp_Dif,cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab=' Mean Temperature',cex.lab=1.4,cex.axis=1.2)
reg=lm(all$rel.amp.ann~all$Temp_Dif)
reg2=lm(all$rel.amp.ann~all$Temp_Dif,weight=all$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
...
## panel 5: : importance of 6-mo cycle as a function of av temperature
plot(all$ratio,all$Av_Temp, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Mean Temperature',cex.lab=1.4,cex.axis=1.2)
reg=lm(all$ratio~all$Av_Temp)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all$ratio~all$Av_Temp,weight=all$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=
1,lwd=1)
title('Importance of \n semi-annual cycle',cex.main=1.5, line = 2)
pval <- lmp(reg) %>% signif(., 5)
...
## panel 6: peak timing as a function of av temperature
plot(all$phase.ann,all$Av_Temp, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Mean Temperature',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,0))
reg=lm(all$phase.ann~all$Av_Temp)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all$phase.ann~all$Av_Temp,weight=all$Sum.Covid)
abline(a=-reg2$coefficients[1]/reg2$coefficients[2], b=1/reg2$coefficients[2],col="purple",lty=1,lwd=1)
title('Peak timing',cex.main=1.5)
pval <- lmp(reg) %>% signif(., 5)
test <- ifelse(pval<0.05, paste0(pval, " *"), pval)
...
## panel 7: amplitude of annual cycle as a function of total precipitation
plot(all$rel.amp.ann,all$Temp_Dif,cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab=' Mean Temperature',cex.lab=1.4,cex.axis=1.2)
reg=lm(all$rel.amp.ann~all$Temp_Dif)
reg2=lm(all$rel.amp.ann~all$Temp_Dif,weight=all$Sum.Covid)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
...
## panel 8: : importance of 6-mo cycle as a function of total precipitation
plot(all$ratio,all$Av_Temp, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Mean Temperature',cex.lab=1.4,cex.axis=1.2)
reg=lm(all$ratio~all$Av_Temp)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all$ratio~all$Av_Temp,weight=all$Sum.Covid)
...
## panel 9: peak timing as a function of total precipitation
plot(all$phase.ann,all$Av_Temp, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase',ylab='Mean Temperature',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,0))
reg=lm(all$phase.ann~all$Av_Temp)
abline(a=-reg$coefficients[1]/reg$coefficients[2], b=1/reg$coefficients[2],col="purple",lty=2,lwd=1)
reg2=lm(all$phase.ann~all$Av_Temp,weight=all$Sum.Covid)
