...
plot(all$phase.ann,all$Latitude, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase (wks;0=Sept-5)',ylab='Latitude',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
...
plot(all$phase.ann,all$Longitude, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase (wks;0=Sept-5)',ylab='Longitude',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
...
plot(all$phase.ann,log(all$population), cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase (wks;0=Sept-5)',ylab='Population Size',cex.lab=1.4,cex.axis=1.2, xlim = c(-15,-5))
...
#p-values
#amp20_reg <- lm(all$rel.amp.ann~all$Latitude + all$Longitude + all$population)
#summary(amp20_reg)
#semi20_reg <- lm(all$ratio~all$Latitude + all$Longitude + all$population)
#summary(semi20_reg)
#phase20_reg <- lm(all$phase.ann~all$Latitude + all$Longitude + all$population)
#summary(phase20_reg)
```
...
## panel 9: peak timing as a function of population
plot(all2$phase.ann,log(all2$population), cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Phase (wks;0=Apr-1)',ylab='Population Size',cex.lab=1.4,cex.axis=1.2, xlim = c(0,15))
...
#p-values
#amp20_reg2 <- lm(all2$rel.amp.ann~all2$Latitude + all2$Longitude + all2$population)
#summary(amp20_reg2)
#semi20_reg2 <- lm(all2$ratio~all2$Latitude + all2$Longitude + all2$population)
#summary(semi20_reg2)
#phase20_reg2 <- lm(all2$phase.ann~all2$Latitude + all2$Longitude + all2$population)
#summary(phase20_reg2)
```
