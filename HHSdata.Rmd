...
```{r linear regression (Spetember 2020)}
hhs_covid <- read.csv("covid_data/COVID-19_Reported_Patient_Impact_and_Hospital_Capacity_by_State_Timeseries__RAW__20240603.csv") 
...
#all.seas.ra$ratio=all.seas.ra$amp.sem.ra/(all.seas.ra$amp.ann.ra+all.seas.ra$amp.sem.ra) ## the ratio of semi-annual to (annual+semi-annual) amplitudes is a good indication of the strength of a 6-mo cycle
...
jpeg("graphs/March20_lat.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
...
jpeg("graphs/March20_long.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
par(mfrow=c(1,3), mar= c(5, 5, 5, 5))
...
jpeg("graphs/March20_pop.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
par(mfrow=c(1,3), mar= c(5, 5, 5, 5))
## panel 7: amplitude of annual cycle as a function of population
plot(all$rel.amp.ann,all$population,cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='Population Size',cex.lab=1.4,cex.axis=1.2)
...
plot(all$ratio,all$population, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Population Size',cex.lab=1.4,cex.axis=1.2)
...
plot(all$phase.ann,all$population, cex=(all$Sum.Covid/100000),lwd=1,col="black",xlab='Phase (wks;0=Sept-5)',ylab='Population Size',cex.lab=1.4,cex.axis=1.2)
...
#all2.seas.ra$ratio=all.seas.ra$amp.sem.ra/(all.seas.ra$amp.ann.ra+all.seas.ra$amp.sem.ra) ## the ratio of semi-annual to (annual+semi-annual) amplitudes is a good indication of the strength of a 6-mo cycle
...
jpeg("graphs/April22_lat.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
par(mfrow=c(1,3), mar= c(5, 5, 5, 5))
## panel 1: amplitude of annual cycle as a function of latitude
...
jpeg("graphs/April22_long.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
par(mfrow=c(1,3), mar= c(5, 5, 5, 5))
## panel 4: amplitude of annual cycle as a function of longitude
...
jpeg("graphs/April22_pop.jpeg", width= 3.25,height= 3.25, units= "in",res= 500,pointsize = 4) 
par(mfrow=c(1,3), mar= c(5, 5, 5, 5))
## panel 7: amplitude of annual cycle as a function of population
plot(all2$rel.amp.ann,all2$population,cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Relative amplitude',ylab='Population Size',cex.lab=1.4,cex.axis=1.2)
...
## panel 8: : importance of 6-mo cycle as a function of population
plot(all2$ratio,all2$population, cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Ratio semi-annual component',ylab='Population Size',cex.lab=1.4,cex.axis=1.2)
...
## panel 9: peak timing as a function of population
plot(all2$phase.ann,all2$population, cex=(all2$Sum.Covid/100000),lwd=1,col="black",xlab='Phase (wks;0=Apr-1)',ylab='Population Size',cex.lab=1.4,cex.axis=1.2)
